...
Gets a Stripe identity verification link for team identity verification

###### JSON Params

| Field      | Type   | Description                                              |
| ---------- | ------ | -------------------------------------------------------- |
| return_url | string | The URL to redirect to after Stripe verifaction succeeds |

###### Response Body

| Field        | Type      | Description                                                             |
| ------------ | --------- | ----------------------------------------------------------------------- |
| id           | snowflake | The identifier for the verification session                             |
...
| redirect_url | string    | The Stripe verification popup URL                                       |
